...
public class DiscountRepositoryImpl implements DiscountRepository {
	...
	public Discount findById(int discountId) {
		String sql = "SELECT id, name, type, value, start_date, end_date " +
				"FROM discounts " +
				"WHERE id = ?";
	...
	public List<Discount> findActiveDiscounts(String productCode, LocalDate date) {
		String sql = "SELECT d.id, d.name, d.type, d.value, d.start_date, d.end_date " +
				"FROM discounts d " +
	...
	public int createDiscount(String discountName, DiscountType discountType, double discountValue, LocalDate startDate,
			LocalDate endDate) {
		String sql = "INSERT INTO discounts (name, type, value, start_date, end_date) " +
				"VALUES (?, ?, ?, ?, ?) " +
				"RETURNING id";
	...
	public void linkProductToDiscount(String productCode, int discountId) {
		String sql = "INSERT INTO product_discounts (product_code, discount_id) " +
				"VALUES (?, ?)";
	...
	public boolean unassignDiscountFromProduct(String productCode, int discountId) {
		String sql = "DELETE FROM product_discounts " +
